...
void BLINKY_PSY_init__(BLINKY_PSY *data__, BOOL retain) {
  __INIT_LOCATED(BOOL,__QX0_3,data__->BLINKY_LED,retain)
  __INIT_LOCATED_VALUE(data__->BLINKY_LED,__BOOL_LITERAL(FALSE))
...
void BLINKY_PSY_body__(BLINKY_PSY *data__) {
  ...
  __SET_VAR(data__->TON0.,IN,,!(__GET_LOCATED(data__->BLINKY_LED,)));
  ...
  __SET_LOCATED(data__->,BLINKY_LED,,__GET_VAR(data__->TOF0.Q,));
